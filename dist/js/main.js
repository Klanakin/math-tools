...
class MathGcf {
    constructor(n1, n2) {
        this.gcf = -1; // Math term - GCF: Greatest Common Factor
        n1 = Math.abs(n1);
        n2 = Math.abs(n2);
        if (n1 >= n2) {
...
const input0 = document.getElementsByClassName("input__box--gcf")[0];
const input1 = document.getElementsByClassName("input__box--gcf")[1];
